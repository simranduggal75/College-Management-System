...
if(move_uploaded_file($file,$destination))
   {
    ...
    $query = "INSERT INTO syllabus(csr,yrr,sbj,myfile)
    VALUES('$csr','$yrr','$sbj','$filename')";
    ...
    if (mysqli_query($conn, $query))
{
 ...
 ?>
  <META HTTP-EQUIV="Refresh" CONTENT="0; URL=http://localhost/project2/upsyllabus.php">
<?php
}
else
 {
...
<center><p class="round2">Upload Syllabus</p><br>
...
<p style="font: italic small-caps bold 20px Georgia, serif;margin-left:40px">Upload Syllabus
<input type="file" name="myfile" id="myfile"><br><br></p>
