...
if(move_uploaded_file($file,$destination))
   {
    ...
    $query = "INSERT INTO project(rno,nm,pt,csr,yrr,sbj,myfile)
    VALUES('$rno','$nm','$pt','$csr','$yrr','$sbj','$filename')";

    if (mysqli_query($conn, $query))
{
 
 echo "<script>alert('Project Report added successfully...');</script>";
 ?>
  <META HTTP-EQUIV="Refresh" CONTENT="0; URL=http://localhost/project2/subproj.php">
<?php
}
else
 {
...
<html>
<head>
<title>Upload Project Report</title>
<style>
body
{
margin: 0;
...
<center><p class="round2">Upload Project Report</p><br>
...
<p style="font: italic small-caps bold 20px Georgia, serif;margin-left:40px">Project Title
<input type="text" name="pt" value="" placeholder="Enter Project Title"><br><br></p>
